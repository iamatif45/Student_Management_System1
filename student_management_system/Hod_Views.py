...
from app.models import CustomUser,Session_Year,Course,Student,Staff,Subject,Staff_Notification,Staff_leave,Staff_Feedback,Student_Notification,Student_Feedback,Student_leave,Attendance,Attendance_Report
...
def ADD_STUDENT(request):
    ...
    if request.method == "POST":
        ...
        if CustomUser.objects.filter(username=username).exists():
            ...
            student.save()
            messages.success(request,user.first_name + " " + user.last_name + " is successflly added")
...
def VIEW_STUDENT(reqest):
    ...
    return render(reqest,'Hod/view_student.html', context)
...
def UPDATE_SUBJECT(request):
    if request.method == "POST":
        ...
        messages.success(request,'Your Subject is Updated Successfully !')
        return redirect('view_subject')
...
def UPDATE_SESSION(request):
    if request.method == "POST":
        ...
        session.save()
        messages.success(request,'Session are Successfully uodated !')
...
def DELETE_SESSION(request,id):
        ...
        session.delete()
        messages.success(request,'Your Session Year is Successfully Deleted !')
        return redirect('view_session')
...
def VIEW_ATTENDANCE(request):
    ...
    if action is not None:
        if request.method == "POST":
            ...
            for i in attendance:
                attendance_id = i.id
                attendeance_report = Attendance_Report.objects.filter(attendance_id = attendance_id)
    ...
    context = {
        ...
        'attendeance_report':attendeance_report,
    }
